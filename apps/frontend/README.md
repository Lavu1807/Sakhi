...
3. Basic request tracing and API rate limiting are enabled, but centralized observability and alerting are still pending
...
4. Add centralized logs, metrics dashboards, and alerting
5. Add deployment profiles for dev/staging/prod
