...
UML diagrams for this project are maintained in `UML_DIAGRAMS.md`.
...
3. Basic request tracing and API rate limiting are enabled, but full centralized observability (logs/metrics/alerting) is still pending.
